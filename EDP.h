...
void   FilterGrC( unsigned char * sup, double *outc, int thr);
 ...
 private:
	...
	int Lbs_S;
	float Lbs_st;
	float * Lbs_S_map = NULL;
	float * spx_D = NULL;
    short int  * XL_tau = NULL;
	short int  * XR_tau = NULL;
	int *tau_XL_d = NULL;
	int *tau_XR_d = NULL;
	int *V_tau_bck = NULL;
	int *R_tau_bck = NULL;
	...
	float CL_INF_R;
    Label *m_answer = NULL;
    Label *gtL_answer = NULL;
	Label *gtR_answer = NULL;
	CostVal *m_D = NULL;
	float * m_D_pR = NULL;
	float * m_D_pL = NULL;
	float PCst_mlt;
	...
	POINT_F * B_L_buf_pp = NULL;
	POINT_F * B_L_buf_mm = NULL;
	POINT_F * B_R_buf_pp = NULL;
	POINT_F * B_R_buf_mm = NULL;
	POINT_CH * B_L_buf_pp_ = NULL;
	POINT_CH * B_L_buf_mm_ = NULL;
	POINT_CH * B_R_buf_pp_ = NULL;
	POINT_CH * B_R_buf_mm_ = NULL;
	REAL * Msg_X_pp = NULL;
	REAL * Msg_X_mm = NULL;
	REAL * Mrg_bf = NULL;
	int * T_max_y = NULL;
	SLTN_CRV  * Sltn_crv = NULL;
	SLTN_CRV  * Sltn_crv_tst = NULL;
	///////////////////////////

    REAL* m_messages = NULL;
	...
	cmplx * cmplxBuf = NULL;
	cmplx * cmplxBuf2 = NULL;
	double *   wght_gauss_cos_buf = NULL;
	cmplx * cmplxCosSin = NULL;
	int         iW_gauss_cos;
	double *  dirBuf = NULL;
	double *  invBuf = NULL;
  //------------------------------
